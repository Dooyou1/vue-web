...
<template>
      ...
      <div class="navbar bg-base-100 shadow-sm">
         ...
         <div class="dropdown dropdown-end">
            ...
            <div tabindex="0" class="card card-compact dropdown-content bg-base-100 z-1 mt-3 w-52 shadow">
               <div class="card-body">
                  <span class="text-lg font-bold">{{ cartStore.quantity }} Items</span>
         ...
         <button @click="Login" v-if="!isLoggedIn" class="btn btn-link">
            Login
         </button>
            ...
            <div class="dropdown dropdown-end">
               <div tabindex="0" role="button" class="btn btn-ghost btn-circle avatar">
                  <div class="w-10 rounded-full">
                     <img alt="Tailwind CSS Navbar component" src="https://pbs.twimg.com/media/FbesNhaVUAAEzUV.jpg" />
                  </div>
               </div>
   ...
   <footer class="footer footer-horizontal footer-center bg-base-200 text-base-content rounded p-10">
      <nav class="grid grid-flow-col gap-4">
         <a class="link link-hover" href="https://www.youtube.com/watch?v=dQw4w9WgXcQ">About us</a>
